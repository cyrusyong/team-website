              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Learn more about our platform, our mission to provide
                    seamless movie ticket booking experiences, and how we're
                    revolutionizing the way you enjoy cinema. Discover our story
                    and what makes us unique in the movie ticketing industry.
                  </p>
                </div>
              </div>
            </Card>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    View detailed information, trailers, and user reviews for
                    each movie.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    checkout. Our cart system provides real-time updates and
                    maintains your selections until you're ready to complete
                    your purchase.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    and download digital tickets whenever needed. Keep track of
                    your movie-watching journey and easily reference your
                    previous bookings for future purchases.
                  </p>
                </div>
              </div>
            </Card>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    our platform. Enjoy features like order tracking, saved
                    preferences, and the ability to leave movie reviews. Simple
                    and secure authentication process for a hassle-free
                    experience.
                  </p>
                </div>
              </div>
      ...
      <section id="process" className="py-20 bg-secondary px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <img src="src/pages/images/development.png"></img>
              <h3 className="text-xl font-semibold mb-4 text-foreground">
              ...
              <p className="text-muted-foreground">
                ...
                <ul className="list-disc pl-6 text-muted-foreground">
                  <li>
                    <strong>GitHub:</strong> Version control system for tracking
